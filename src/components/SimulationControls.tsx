...
interface SimulationControlsProps {
  ...
  onTrafficDensityChange: (density: TrafficLevel) => void;
}
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <button
                  onClick={() => onStartMapSelect && onStartMapSelect()}
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <button
                  onClick={() => onEndMapSelect && onEndMapSelect()}
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {(['Low', 'Medium', 'High'] as TrafficLevel[]).map((level) => (
                <button
                  key={level}
                  onClick={() => onTrafficDensityChange(level)}
                  className={`px-3 py-2 rounded-lg text-xs font-semibold transition-colors ${trafficDensity === level
            ...
            <p className="text-[10px] text-gray-500 mt-2 italic">
              *Traffic impacts travel time and freshness loss.
            </p>
          </div>
